...
fwrite($ou1, "Total Rows: " . $lines . "\r\n");
fwrite($ou1, "Total number of bad lines: " . $badlines . "\r\n");
fwrite($ou1, "Total Size: " . $size . "\r\n";
fwrite($ou1, "Total Remote Requests: " . $numremote . "\r\n");
fwrite($ou1, "Total local Requests: " . $numlocal . "\r\n");

if ($num200 != 0) {
  fwrite($ou1, "Total 200 Requests: " . $num200 . "\r\n");
}
if($num302 != 0){
  fwrite($ou1, "Total 302 Requests: " . $num302 . "\r\n");
}
if ($num304 != 0) {
  fwrite($ou1, "Total 304 Requests: " . $num304 . "\r\n");
}
if ($num403 != 0) {
  fwrite($ou1, "Total 403 Requests: " . $num403 . "\r\n");
}
if ($num404 != 0) {
  fwrite($ou1, "Total 404 Requests: " . $num404 . "\r\n");
}
if ($num300 != 0) {
  fwrite($ou1, "Total 300 Requests: " . $num300 . "\r\n");
}
if ($num301 != 0) {
  fwrite($ou1, "Total 301 Requests: " . $num301 . "\r\n");
}
if ($num307 != 0) {
  fwrite($ou1, "Total 307 Requests: " . $num307 . "\r\n");
}
if ($num400 != 0) {
  fwrite($ou1, "Total 400 Requests: " . $num400 . "\r\n");
}
if ($num401 != 0) {
  fwrite($ou1, "Total 401 Requests: " . $num401 . "\r\n");
}
if ($num403 != 0) {
  fwrite($ou1, "Total 403 Requests: " . $num403 . "\r\n");
}
if ($num410 != 0) {
  fwrite($ou1, "Total 410 Requests: " . $num410 . "\r\n");
}
if ($num500 != 0) {
  fwrite($ou1, "Total 500 Requests: " . $num500 . "\r\n");
}
if ($num501 != 0) {
  fwrite($ou1, "Total 501 Requests: " . $num501 . "\r\n");
}
if ($num503 != 0) {
  fwrite($ou1, "Total 503 Requests: " . $num503 . "\r\n");
}
if ($num550 != 0) {
  fwrite($ou1, "Total 550 Requests: " . $num550 . "\r\n");
}
//Closes file
fclose($handle);
